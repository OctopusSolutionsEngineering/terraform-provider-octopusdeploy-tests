module github.com/mcasperson/terraform-provider-octopusdeploy-tests
...
require (
	...
	github.com/mcasperson/OctopusTerraformTestFramework v0.0.0-20230307031735-be2c3b4e9c18
